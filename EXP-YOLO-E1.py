...
model.predict(source="E.mp4", save=True, imgsz=320, conf=0.5)

#3------------------------------------------------tracking model
# Configure the tracking parameters and run the tracker
model = YOLO('yolov8n.pt')

results = model.track(source="E.mp4",conf=0.3, iou=0.5, save=True, tracker="bytetrack.yaml")

#4---------------------------------------------------Line Crossing Detection in Video using ByteTrack
...
video_info = sv.VideoInfo.from_video_path("E.mp4")
with sv.VideoSink("output_single_line_E.mp4", video_info) as sink:
